...
function clickEvent(e) {
    ...
    try {
        ...
        pvClickCount += r;
        var i = new Image(1, 1);
        i.src = ('https:'==document.location.protocol? "https":"http") + "://trace.qq.com/collect?pj=8888&url=" + escape(location.href) + "&w=" + screen.width + "&x=" + t + "&y=" + n + "&v=" + r + "&u=" + trimUin(pgvGetCookieByName("o_cookie")),
        delete i
    } catch(s) {}
}
function tracert() {
    if (pgvIsPgvDomain()) {
        ...
        sendUrl.src = ('https:'==document.location.protocol? "https":"http") + "://trace.qq.com/collect?" + t;
...
function staybounce() {
    ...
    var e = dt.getTime(),
    t = new Image(1, 1);
    t.src = ('https:'==document.location.protocol? "https":"http") + "://trace.qq.com/collect?pj=8887&url=" + escape(location.href) + "&t=" + parseInt((e - pvStartTime) / 1e3) + "&v=" + pvClickCount + "&u=" + trimUin(pgvGetCookieByName("o_cookie")),
    delete t
}
var pvNone = "-",
pvStartTime = 0,
...
if (typeof pvRepeatCount == "undefined") var pvRepeatCount = 1; (function() {
    ...
    tcss.prototype = {
        ...
        run: function() {
            ...
            _cookie.save(),
            this.url.unshift(('https:'==document.location.protocol? "https":"http") + "://trace.qq.com/tcss/pingfore." + this.getCookieSetDomain(_curDomain) + "/pingd?"),
        ...
        watchClick: function(e) {
            try {
                ...
                if (t) {
                    ...
                    i.url.unshift(('https:'==document.location.protocol? "https":"http") + "://trace.qq.com/tcss/pingfore." + this.getCookieSetDomain(_curDomain) + "/pingd?"),
        ...
        sendClick: function() {
            _params.hottag && (this.url.push(this.getDomainInfo(!0)), this.url.push("&hottag=" + escape(_params.hottag)), this.url.push("&hotx=9999&hoty=9999"), this.url.push("&rand=" + Math.round(Math.random() * 1e5)), this.url.unshift(('https:'==document.location.protocol? "https":"http") + "://trace.qq.com/tcss/pingfore." + this.getCookieSetDomain(_curDomain) + "/pingd?"), this.sendInfo(this.url.join("")))
        },
        pgvGetArgs: function() {
            this.getDomainInfo();
            var e = [];
